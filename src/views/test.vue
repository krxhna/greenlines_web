<template>
  <div class="homesearch">
    <div class="nav bg-dark text-light" style="display:flex; justify-content:space-evenly;" v-if="!mobile && !clickedsignup">
...
</svg><div class="d">Desktop requires signup to work </div><b-button @click="push2signup">signup</b-button>
      </div>
    </div>
